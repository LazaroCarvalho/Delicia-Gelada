                ...
                <div class="conteudo center">
                    ...
                    <div class="container_cms center">
                        ...
                        <div class="cms_conteudo" id="introducaoConteudo">
                            <div class="card_cadastro_conteudo center">
                                <form name="formularioConteudo" method="post" action="bd/inserirIntroducaoLojas.php" enctype="multipart/form-data">
                                    ...
                                    <div class="container_color float-left">
                                        <input type="color" value="#ffffff" name="cor_fundo" required>
                                        <label>Cor de fundo da seção</label>
                                    </div>
                                    <div class="container-color-font-intro float-left">
                                        <label>Cor do texto: </label>
                                        <select name="cor_texto" required>
                                            <option value="light">
                                                Light
                                            </option>
                                            <option value="dark">
