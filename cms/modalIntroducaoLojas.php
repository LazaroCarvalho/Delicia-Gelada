<?php 
    ...
    if(isset($_POST['codigo']))
    {
        ...
        $sql = "SELECT * FROM introducao_lojas WHERE id = ".$_POST['codigo'];
        ...
        while($rsConteudo = mysqli_fetch_array($select))
        {
            ...
            $cor_texto = $rsConteudo['cor_texto'];
...
<html lang="pt-br">
    ...
    <body>
        <form name="frmModalConteudo" method="post" action="bd/inserirIntroducaoLojas.php">
            <div class="cont-modal" style="background-color: <?=$corBackground?>">
                <div class="cont-titulo-modal center">
                    <input name="titulo" class="titulo-modal txt-center center" 
                            value="<?=$titulo?>" style="background-color: <?=$corBackground?>; color: <?=$cor_texto?>">
                </div>
                <div class="text-imagem-modal center">
                    ...
                    <textarea name="texto" class="texto-modal float-left" style="background-color: <?=$corBackground?>;color: <?=$cor_texto?>"><?=$texto?>
                    </textarea>
                </div>
                <div class="colors-options center" style="color: <?=$corFont?>">
                    <div class="modal-cortext" id="color-background">
                        <label style="color: <?=$cor_texto?>">Cor de fundo: </label><input name="cor_fundo" value="<?=$corBackground?>" type="color">
                    </div>
                    <div class="modal-cortext" id="text-color">
                        <label style="color: <?=$cor_texto?>">Tema da fonte: </label>
