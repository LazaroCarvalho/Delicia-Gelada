<?php 
    ...
    if(isset($_GET['codigo']))
    {
        ...
        $sql = "SELECT * FROM sectiondois_sobre WHERE id = ".$_GET['codigo'];
                            ...
                            <div id="container_usuarios_cadastrados_header">
                                <div class="center crud-headerSobre" id="tabela_usuarios_cadastrados-header">
                                    ...
                                    <?php 
                                        ...
                                        $sql = "SELECT * FROM sectiondois_sobre";
                                        $select = mysqli_query($conexao, $sql);
                                    ...
                                    <div class="container_dados_campo <?=$corLinha?>">
                                        ...
                                        <?php if($rsConteudos['status'] == 1){ ?>
                                            <a href="bd/statusSectionDois.php?codigo=<?=$rsConteudos['id']?>&modo=status&status=<?=$rsConteudos['status']?>">
                                        ...
                                        <div class="campo_info">
                                            <div class="opcoes_imagens">
                                                <a href="secaoDoisSobre.php?modo=editar&codigo=<?=$rsConteudos['id'];?>">
